...
#Dividing and integer give an integer back, dividing by a float returns a float.
...
#    odd numbers?
# Even numbers are divisable with no remainder giving a value of 0
# Odd numbers are divisable with a remainder giving a value of 1
